...
import products.ElectronicProducts;
...
public class CommonTools {
	...
	public static String readProterties( String inputString ) {
        ...
        try {
            InputStream inStream =  new FileInputStream(System.getProperty("user.dir")+"\\src\\main\\resources\\products.properties");
			pro.load(inStream);
		} catch (IOException e) {
			e.printStackTrace();
		}
		try {
           ...
           /* String result = new String(words.getBytes("ISO-8859-1"), "UTF-8");*/
			return words;
		} catch (Exception e) {
